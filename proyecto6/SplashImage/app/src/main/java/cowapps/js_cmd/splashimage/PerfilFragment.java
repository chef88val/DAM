    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nick.equals(""))
                    Toast.makeText(getContext(),"No tienes nick?",Toast.LENGTH_SHORT).show();
                else
                edad= Integer.parseInt(txt_edad.getText().toString());
                if(edad<18){//Comprobamos la edad
                    Toast.makeText(getContext(),"Eres menor de edad",Toast.LENGTH_SHORT).show();
                }else{
