...
public  class MenuAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        //Creamos un objeto en el que incluiremos los elementos del menu
        ...
        switch (position){
            case 0:
                imagen.setImageDrawable(context.getDrawable(R.drawable.user));
                //texto.setBackgroundColor(Color.WHITE);
                //imagen.setBackgroundColor(Color.RED);
                break;
            case 1:
                imagen.setImageDrawable(context.getDrawable(R.drawable.dice));
                //texto.setBackgroundColor(Color.LTGRAY);
                //imagen.setBackgroundColor(Color.BLUE);
                break;
            case 2:
                imagen.setImageDrawable(context.getDrawable(R.drawable.instrucciones));
                //texto.setBackgroundColor(Color.WHITE);
